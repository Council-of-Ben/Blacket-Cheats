(() => {
    ...
    if(!Object.keys(blacket.badges).includes(badge)) {
        ...
        if(blacket.user.badges.length = 0) {
            // add container if user has no badges
            $('.styles__headerInfo___1oWlb-camelCase')[0].append('<div class="styles__headerBadges___ffKa4-camelCase" style="position: absolute;margin-left: 290px;display: inline-block;padding: 2.5px;"><img loading="lazy" class="styles__headerBadgeBg___12ogR-camelCase" draggable="false" src="/content/banners/Default.png"></div>');
        }
